...
> A bug fix that removes the delay before your familiar (animal companion) spawns when entering a room.

## Features

- Fixes a bug that caused a noticeable delay before your familiar would appear at the start of a new location.
- Your familiar will now spawn immediately upon entering a room.
